...
title: Qui som
permalink: /qui-som/
actualitzat: 2026-09-17
versio: 8
---

<div style="text-align: center;">
  {%- for membre in junta %}{% assign mod_start = forloop.index0 | modulo: 4 %}
    ...
    {%- assign mod_end = forloop.index | modulo: 4 %}{% if mod_end == 0 or forloop.last %}</div>{% endif %}
  {%- endfor %}
</div>
